...
const TestimonialListModel = require('../model/Admin/testimonial_model/testimonial_model')
app.post('/Admin/testimonial/testimonial_create', TestimonialListModel.testimonial_create)
app.post('/Admin/testimonial/testimonial_delete/:id', TestimonialListModel.testimonial_delete)
app.post('/Admin/testimonial/testimonial_edit/:id', TestimonialListModel.testimonial_edit)
app.get('/Admin/testimonial/testimonial_single/:id', TestimonialListModel.testimonial_single)
app.get('/Admin/testimonial/testimonial_list', TestimonialListModel.testimonial_list)
app.get('/Admin/testimonial/testimonial_list/:pageNo/:perPage', TestimonialListModel.testimonial_list_paigination)
...
app.post('/Admin/menu_item/menu_Item_create', usersModel.menu_Item_create_v2)
...
const MenuDesignModel = require('../model/Admin/menu_design_model/menu_design_model')
app.get('/Admin/menu_design/menu_design_all', MenuDesignModel.menu_design_list)
app.get('/Admin/menu/menu_list', MenuDesignModel.menu_list)
app.get('/Admin/menu/menu_list_paigination/:pageNo/:perPage', MenuDesignModel.menu_list_paigination)
app.get('/Admin/menu_theme/menu_theme_list', MenuDesignModel.menu_theme_list)
app.get('/Admin/menu/menu_single_list/:id', MenuDesignModel.menu_single)
app.post('/Admin/menu/menu_update/:id', MenuDesignModel.menu_update)
app.post('/Admin/menu_theme/menu_create', MenuDesignModel.menu_create)
app.post('/Admin/menu_theme/menu_create_item', MenuDesignModel.menu_create_item)
app.post('/Admin/menu_theme/menu_delete/:id', MenuDesignModel.menu_delete)
...
app.post(
  "/Admin/video_gallery/video_gallery_search",
  VideoGalleryModel.video_gallery_search
);
...
const PhotoGalleryModel = require('../model/Admin/photo_gallery_model/photo_gallery_model')
app.post("/Admin/photo_gallery/photo_gallery_create", PhotoGalleryModel.photo_gallery_create
);
app.get("/Admin/photo_gallery/events_gallery_list", PhotoGalleryModel.events_gallery_list
);
app.get("/Admin/photo_gallery/events_gallery_list_paigination/:pageNo/:perPage", PhotoGalleryModel.events_gallery_list_paigination
);
app.post("/Admin/photo_gallery/events_gallery_search", PhotoGalleryModel.events_gallery_search
);
app.post("/Admin/photo_gallery/events_gallery_list_print", PhotoGalleryModel.events_gallery_list_print
);
app.post("/Admin/photo_gallery/events_gallery_list_pdf", PhotoGalleryModel.events_gallery_list_pdf
);
app.get("/Admin/photo_gallery/events_gallery_single/:id", PhotoGalleryModel.events_gallery_single
);
app.post("/Admin/photo_gallery/events_gallery_delete/:id", PhotoGalleryModel.events_gallery_delete
);
app.post("/Admin/photo_gallery/events_gallery_image_delete/:id", PhotoGalleryModel.events_gallery_image_delete
);
app.post("/Admin/photo_gallery/photo_gallery_update/:id", PhotoGalleryModel.photo_gallery_update
);
...
app.get('/api/menu/:admin_template_menu_id', (req, res) => {
  const adminTemplateMenuId = req.params.admin_template_menu_id;

  fetchMenuData(null, adminTemplateMenuId, (err, result) => {
    if (err) {
      console.error('Error fetching menu data:', err);
      res.status(500).json({ error: 'Internal Server Error' });
      return;
...
// Recursive function to fetch hierarchical data based on admin_template_menu_id
function fetchMenuData(parentId, adminTemplateMenuId, callback) {
  const query = `
    SELECT
      id,
      title_en,
    ...
    WHERE
      parent_id ${parentId ? `= ${parentId}` : 'IS NULL'}
      AND admin_template_menu_id = ?
  `;

  db.query(query, [adminTemplateMenuId], (err, rows) => {
    if (err) {
      callback(err, null);
      return;
    }
    ...
    rows.forEach((row) => {
      ...
      fetchMenuData(row.id, adminTemplateMenuId, (err, children) => {
        if (err) {
          callback(err, null);
          return;
        }
